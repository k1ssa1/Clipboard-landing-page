    ...
    return ( 
        <div className='mt-10 mb-10'>
            ...
            <div className='mt-10 mx-32'>
                <ul className='flex flex-row justify-center items-center max-sm:flex-col'>
                    <li className='py-4 px-10 mx-2 text-center flex flex-col items-center justify-center max-sm:mb-5'>
