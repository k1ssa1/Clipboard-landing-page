            ...
            <div className='mt-10'>
                <ul className='flex flex-row justify-center items-center'>
                    <li className='py-4 px-10 mx-2 text-center flex flex-col items-center justify-center'>
                        ...
                        <p className='mt-4 w-2/3 text-gray-400 '>Ensure sensitive information never makes its way to your clipboard by excluding certain sources.</p>
                    </li>
                    <li className='py-4 px-10 mx-2 text-center flex flex-col items-center justify-center'>
                        <img src={book} alt="text_icon" className='h-8'/>
                        <h6 className='mt-4 font-bold'> Plain text snippets</h6>
                        <p className='mt-4 w-2/3 text-gray-400 '>Remove unwanted formatting from copied text for a consistent look</p>
                    </li>
                    <li className='py-4 px-10 mx-2 text-center flex flex-col items-center justify-center'>
                        <img src={preview} alt="preview_icon" className='h-8'/>
                        <h6 className='mt-4 font-bold'>Sneak preview</h6>
                        <p className='mt-4 w-2/3 text-gray-400 '>Quick preview of all snippets on your Clipboard for east access.</p>
                    </li>
                </ul>
            </div>
        </div>
